...
Partial Public Class UsersDataSet
    ...
    Partial Public Class accountDataTable
        ...
        Private columnuseracc As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public ReadOnly Property useraccColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnuseracc
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddaccountRow(ByVal useracc As String, ByVal pass As String) As accountRow
            Dim rowaccountRow As accountRow = CType(Me.NewRow,accountRow)
            Dim columnValuesArray() As Object = New Object() {useracc, pass}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Friend Sub InitVars()
            Me.columnuseracc = MyBase.Columns("useracc")
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Sub InitClass()
            Me.columnuseracc = New Global.System.Data.DataColumn("useracc", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnuseracc)
            ...
            Me.columnuseracc.AllowDBNull = false
            Me.columnuseracc.MaxLength = 50
    ...
    Partial Public Class accountRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Property useracc() As String
            Get
                Return CType(Me(Me.tableaccount.useraccColumn),String)
            End Get
            Set
                Me(Me.tableaccount.useraccColumn) = value
            End Set
        End Property
...
Namespace UsersDataSetTableAdapters
    ...
    Partial Public Class accountTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[account] ([useracc], [pass]) VALUES (@useracc, @pass)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@useracc", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "useracc", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT useracc, pass FROM dbo.account"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT useracc, pass FROM dbo.account WHERE useracc = @useracc"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@useracc", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "useracc", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As UsersDataSet.accountDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As UsersDataSet.accountDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As UsersDataSet.accountDataTable = New UsersDataSet.accountDataTable()
        ...
        Public Overloads Overridable Function FillByUserAcc(ByVal dataTable As UsersDataSet.accountDataTable, ByVal useracc As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (useracc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("useracc")
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(useracc,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        Public Overloads Overridable Function GetDataByUserAcc(ByVal useracc As String) As UsersDataSet.accountDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (useracc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("useracc")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As UsersDataSet.accountDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal useracc As String, ByVal pass As String) As Integer
            If (useracc Is Nothing) Then
                Throw New Global.System.ArgumentNullException("useracc")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(useracc,String)
            End If
